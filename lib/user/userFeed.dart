              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final tag = post['tag'] ?? 'None'; // Show the post's tag
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => Userpostupload(
                username: username,
                email: email,
              ),
            ),
...
// In your Userpostupload screen, make sure to accept the username and email as parameters:
